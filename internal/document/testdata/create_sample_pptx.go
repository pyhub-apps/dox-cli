...
<Override PartName="/ppt/slides/slide2.xml" ContentType="application/vnd.openxmlformats-officedocument.presentationml.slide+xml"/>
	...
	err := os.WriteFile("sample_presentation.pptx", buf.Bytes(), 0644)
	if err != nil {
		fmt.Printf("Error creating sample_presentation.pptx: %v\n", err)
	} else {
		fmt.Println("Created sample_presentation.pptx")
	}
}